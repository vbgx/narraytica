...
| Feature | Description |
|--------|-------------|
| Quote Search | Find exact or semantic matches in speech |
| Context View | See the surrounding dialogue and speaker |
| Timecode Linking | Jump directly to the moment in the video |
| Source Metadata | Channel, date, speaker, and language |
| Citation Export | Copy academic or journalistic references |
