...
TrendPulse exists to answer questions like:

- When did this topic start gaining attention?
- Is sentiment becoming more positive or negative?
- Which speakers are amplifying a trend?
- How do different communities talk about the same subject?

It turns raw speech data into **narrative trend intelligence**.
...
| Feature | Description |
|--------|-------------|
| Topic Trends | Track how often a topic appears over time |
| Sentiment Evolution | See how tone shifts around a subject |
| Speaker Influence | Identify which speakers drive a conversation |
| Comparative Trends | Compare multiple ideas across time |
| Early Signals | Detect emerging themes before they peak |
