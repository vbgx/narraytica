# ClipQuote — Narralytica

ClipQuote is a tool for journalists and editors to extract **accurate, verifiable quotes from video content**.

It turns spoken moments into **ready-to-use citations**, complete with context, speaker, and timestamp.

ClipQuote bridges the gap between **video speech** and **publishable text**.
...
| Feature | Description |
|--------|-------------|
| Exact Quote Search | Find precise spoken phrases |
| Context View | Display surrounding dialogue |
| Speaker Attribution | Identify who said the quote |
| Timecode Reference | Link directly to the moment in video |
| Copy-Ready Formatting | Export citation for articles |
